...
- `manifest/zont.yaml` — local description of the integration-owned panel, currently v0.9.6.
...
- Empty numeric states remain missing; DHW operation is never inferred from temperature.
- A transport label requires an explicit confirmed source contract with evidence; controller `online` alone is insufficient.
